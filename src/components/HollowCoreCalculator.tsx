          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col gap-1.5 animate-fade-in">
              <label className="text-sm font-semibold text-neutral-700 flex justify-between">
                ...
                <span className="text-xs text-[#C62828] font-bold">มาตรฐานทางวิศวกรรม: 0.35, 0.60, 1.20 म.</span>
              </label>
              <input
                type="number"
                value={hcWidth}
              ...
              <div className="flex gap-1.5 mt-1">
                {[0.35, 0.60, 1.20].map((preset) => (
                  <button
                    key={preset}
                    type="button"
                    onClick={() => setHcWidth(preset)}
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="flex flex-wrap gap-1 mt-1">
                {[3.0, 4.0, 5.0, 6.0, 7.0, 8.0, 10.0].map((preset) => (
                  <button
                    key={preset}
                    type="button"
                    onClick={() => setHcLength(preset)}
                    className={`px-3 py-1.5 text-xs font-bold rounded-lg border transition ${
                      hcLength === preset
                        ? "bg-[#C62828] text-white border-transparent shadow-[#C62828]/20 shadow-sm scale-102"
                        : "bg-white hover:bg-neutral-50 text-neutral-600 border-neutral-200 hover:border-neutral-300"
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-sm font-semibold text-[#37474F] flex justify-between">
                ...
                <span className="text-xs text-neutral-500 font-medium">เว้นว่างคือ ฿{settings.prices.hcPriceSqm} / ตร.ม.</span>
              </label>
              <input
                type="number"
                value={hcPricePerSqm}
